    ...
    <FooterContainer  id="footer">
      <BoxContainer>
        ...
        <Box data-aos="fade-up" data-aos-delay="200">
          <h3>Contact Info</h3>
          <p><i className="bi bi-telephone-fill"></i>+91 8104050546</p>
          <p><i className="bi bi-envelope-fill"></i>vinitpawar958@gmail.com</p>
          <p><i className="bi bi-map-fill"></i>Mumbai, India-400078</p>
          <div className="share">
      ...
      <Credit>
        Designed with <i className="bi bi-heart-fill"></i> by <a href="#"> Vinit</a>
      </Credit>
    </FooterContainer>
  );
}
